    ...
    <div>
      ...
      <div className="table-responsive">
        {stadeList && stadeList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('codePostal')}>
                  Code Postal <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {stadeList.map((stade, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{stade.ville}</td>
                  <td>{stade.user ? stade.user.id : ''}</td>
                  <td>{stade.club ? <Link to={`club/${stade.club.id}`}>{stade.club.nom}</Link> : ''}</td>
          ...
          !loading && <div className="alert alert-warning">No Stades found</div>
        )}
      </div>
